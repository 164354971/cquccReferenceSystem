package com.cqucc.pojo.historyExam;
...
public class HistoryExam {
    ...
    private Integer personSum ;//int         not null comment '应到总人数',
    private Integer personNum ;//int         not null comment '实到总人数',
    private Integer cheatNum  ;//int         not null comment '违纪总人数'

    public HistoryExam() {
    }

    public HistoryExam(Integer id, Boolean online, String loc, Integer room, String term, Integer week, String startTime, String endTime, Integer time, Integer grade, String college, String profession, String course, Boolean rebuild, Integer personSum, Integer personNum, Integer cheatNum) {
        this.id = id;
        this.online = online;
        this.loc = loc;
        this.room = room;
